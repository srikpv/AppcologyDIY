    ...
    def count_votes(self):
        ...
        for block in self.chain:
             for vote in block["votes"]:
                if vote["candidate"] in candidates.keys():
...
def mine():
    ...
    # The voter is "0" to signify that this node has mined a new coin.
    blockchain.new_vote(
        voter="0",
        candidate=node_identifier,
    )
...
def count_votes():
    return jsonify(blockchain.count_votes())
...
if __name__ == '__main__':
    ...
    app.run(host='127.1.1.0', port=port)
